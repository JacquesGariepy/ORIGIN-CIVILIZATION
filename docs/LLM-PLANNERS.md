...
Everything sent to a planner and everything it returned (prompt, arguments or HTTP request, events, stderr, raw output, verdict) is readable in **AI live** and **Full ledger**, including for failed calls.
